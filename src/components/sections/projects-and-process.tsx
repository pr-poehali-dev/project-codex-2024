...
const projects = [
  {
    name: "Скандинавия",
    area: "120 м²",
    material: "Одноэтажный, газоблок, панорамные окна, плоская кровля",
    price: "3 900 000 ₽",
  ...
  },
  {
    name: "Шале",
    area: "150 м²",
    material: "Двухэтажный, брус + кирпич, двускатная крыша, большая терраса",
    price: "5 400 000 ₽",
  ...
  },
  {
    name: "Хай-тек",
    area: "180 м²",
    material: "Монолит+утеплитель, эксплуатируемая кровля, современный дизайн",
    price: "7 200 000 ₽",
  ...
  },
  {
    name: "Классика",
    area: "140 м²",
    material: "Керамоблок, эркеры, мансардный этаж",
    price: "4 800 000 ₽",
    promo: "Бесплатный дизайн интерьера",
    color: "purple",
  },
  {
    name: "Фахверк",
    area: "200 м²",
    material: "Деревянный каркас, панорамное остекление, евроотделка",
    price: "8 500 000 ₽",
    promo: "Скидка 5% при заказе до конца месяца",
    color: "pink",
  },
  {
    name: "Мини-дом",
    area: "80 м²",
    material: "Брус, компактный — идеален для небольшого участка",
    price: "2 400 000 ₽",
    promo: "Фундамент в подарок",
    color: "purple",
  },
]
