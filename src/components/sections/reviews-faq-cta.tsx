...
const reviews = [
  {
    name: "Алексей",
    city: "г. Москва",
    text: "Заказал строительство дома «Шале» в NEXT BUILD. Сделали под ключ за 4 месяца, как и обещали. Смета не выросла ни на рубль. Качество кладки и кровли — отличное. Постоянный контроль прораба, фотоотчёт каждый день. Твёрдая 5! Спасибо команде NEXT BUILD.",
  },
  {
    name: "Виктория",
        ...
        <div className="max-w-[800px] w-full mx-auto relative z-10">
          <div className="text-center mb-12">
            ...
            <p className="text-[#A7ABB3] text-base md:text-lg mb-4 leading-relaxed max-w-[560px] mx-auto">
              Сделайте первый шаг к дому своей мечты. Оставьте заявку — мы бесплатно рассчитаем смету и поможем выбрать проект.
            </p>
          </div>
